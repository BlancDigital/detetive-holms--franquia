...
$envio_cliente  = mail($emailatt_cliente,"[Lead] Detetive Holms - Franquia", $corpoHTML, $header_cliente);
...
$envio_leads     = mail($emailatt_leads,"[Lead] Detetive Holms - Franquia", $corpoHTML_leads, $header_leads); 
